...
init_extends();
function compose() {
  for (var _len = arguments.length, styles8 = new Array(_len), _key = 0; _key < _len; _key++) {
    styles8[_key] = arguments[_key];
  }
  var fn = function fn2(props) {
    return styles8.reduce(function(acc, style2) {
  ...
  fn.propTypes = true ? styles8.reduce(function(acc, style2) {
    return _extends(acc, style2.propTypes);
  }, {}) : {};
  fn.filterProps = styles8.reduce(function(acc, style2) {
...
function isMuiElement(element, muiNames) {
  return React16.isValidElement(element) && muiNames.indexOf(element.type.muiName) !== -1;
}
...
var useEnhancedEffect3 = typeof window === "undefined" ? React18.useEffect : React18.useLayoutEffect;
var ListItem = React18.forwardRef(function ListItem2(props, ref) {
  ...
  var context = React18.useContext(ListContext_default);
  var childContext = {
    dense: dense || context.dense || false,
    alignItems: alignItems2
  };
  var listItemRef = React18.useRef(null);
  ...
  var children = React18.Children.toArray(childrenProp);
  var hasSecondaryAction = children.length && isMuiElement(children[children.length - 1], ["ListItemSecondaryAction"]);
  var handleOwnRef = React18.useCallback(function(instance) {
  ...
  if (hasSecondaryAction) {
    ...
    return React18.createElement(ListContext_default.Provider, {
      value: childContext
    }, React18.createElement(ContainerComponent, _extends({
      className: clsx_m_default(classes.container, ContainerClassName),
      ref: handleRef
    }, ContainerProps), React18.createElement(Component, componentProps, children), children.pop()));
  }
  return React18.createElement(ListContext_default.Provider, {
    value: childContext
  }, React18.createElement(Component, _extends({
    ref: handleRef
  }, componentProps), children));
});
true ? ListItem.propTypes = {
  alignItems: import_prop_types14.default.oneOf(["flex-start", "center"]),
  ...
  children: chainPropTypes(import_prop_types14.default.node, function(props) {
    var children = React18.Children.toArray(props.children);
  ...
  ContainerComponent: import_prop_types14.default.elementType,
...
var ListItem_default = withStyles_default2(styles4, {
  name: "MuiListItem"
})(ListItem);
...
var MenuItem = React19.forwardRef(function MenuItem2(props, ref) {
  ...
  return React19.createElement(ListItem_default, _extends({
    button: true,
    role,
    tabIndex,
    component,
...
true ? MenuItem.propTypes = {
  ...
  ListItemClasses: import_prop_types15.default.object,
...
var MenuItem_default = withStyles_default2(styles6, {
  name: "MuiMenuItem"
})(MenuItem);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-7JKUOUVU.js.map
