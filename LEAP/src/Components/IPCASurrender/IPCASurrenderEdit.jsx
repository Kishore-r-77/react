    ...
    <div>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>LEAPS Surrender Edit</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <form autoComplete="off">
            <Box sx={{ flexGrow: 1 }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={8} md={6} lg={2}>
                  <TextField
                    label="Ulip Surrender Charges"
                    className="formtext"
                    id="ulipSurrenderCharges"
                    value={ulipSurrenderCharges}
                    placeholder="Ulip Surrender Charges"
