...
function UinMaster() {
    ...
    axios
      .post(
        `http://localhost:8080/uinMaster/add/${userId}`,
        {
          ...
          revesionaryBonus: uinMasterData.revesionaryBonus,
          interimBonus: uinMasterData.interimBonus,
          terminalBonus: uinMasterData.terminalBonus,
          guaranteedBonus: uinMasterData.guaranteedBonus,
          loyaltyBonus: uinMasterData.loyaltyBonus,
          flcEligibility: uinMasterData.flcEligibility,
          surrenderChargeRate: uinMasterData.surrenderChargeRate,
    ...
    axios
      .patch(
        `http://localhost:8080/uinMaster/update/${record.id}/${userId}`,
        {
          ...
          revesionaryBonus: record.revesionaryBonus,
          ...
          flcEligibility: record.flcEligibility,
          surrenderChargeRate: record.surrenderChargeRate,
  ...
  const upload = (e) => {
    ...
    axios.post(`http://localhost:8080/uinMaster/upload`, formData, {
      headers: {
