...
import SurrenderFundDetailsPasAdd from "./SurrenderFundDetailsPasAdd";
import SurrenderFundDetailsPasEdit from "./SurrenderFundDetailsPasEdit";
import SurrenderFundDetailsPasInfo from "./SurrenderFundDetailsPasInfo";
...
function SurrenderFundDetails() {
  ...
  const getData = () => {
    axios
      .get(`http://localhost:8080/surenderFundDetails/getall/${userId}`, {
        headers: {
  ...
  const handleFormSubmit = () => {
    axios
      .post(
        `http://localhost:8080/surenderFundDetails/add/${userId}`,
        {
  ...
  const editFormSubmit = () => {
    axios
      .patch(
        `http://localhost:8080/surenderFundDetails/update/${record.id}/${userId}`,
        {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .patch(
        `http://localhost:8080/surenderFundDetails/softdelete/${id}/${userId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
  ...
  const globalsearch = (val) => {
    val === ""
      ? getData()
      : axios
          .get(`http://localhost:8080/surenderFundDetails/search/${val}`, {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
          })
  ...
  return (
    <>
      <div className="classTitle">
        <h2>
          {" "}
          <b>Surrender Fund Details PAS</b>{" "}
        </h2>
      </div>
...
export default SurrenderFundDetails;
