...
function DeathClaimCoverEdit({
  ...
  const editFormSubmit = () => {
    const body = {
      ...
      riskComDate: moment(data.riskComDate)
        .format("YYYYMMDD")
        .toString(),
    ...
    axios
      .patch(
        `http://localhost:8080/deathClaimCoverPas/update/${data.id}/${userId}`,
        body,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
...
export default DeathClaimCoverEdit;
