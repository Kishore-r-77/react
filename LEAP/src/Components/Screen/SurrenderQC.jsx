...
import SurrenderFundCheck from "./SurrenderFundCheck";
...
function SurrenderQC({ data, open, close, getData }) {
  ...
  const qcSubmit = () => {
    axios
      .patch(
        `http://localhost:8080/ipcaSurrender/qcUpdate/${purpleData.policyNo}/${userId}`,
        {
          purpleApprovalFlag: purpleData.purpleApprovalFlag,
          purpleApprovalRemark: purpleData.purpleApprovalRemark,
        },
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
  ...
  const getUINData = () => {
    axios
      .get(
        `http://localhost:8080/uinMaster/getBySurrPolicyNo/${data.policyNo}`,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
                    ...
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={8} md={6} lg={4}>
                        <TextField
                          ...
                          label="Log Date"
                          id="logDate"
                          value={moment(transData.logDate).format("DD/MM/YYYY")}
                        ...
                        <Grid container spacing={1}>
                          ...
                          <Grid item xs={8} md={6} lg={4}>
                            <TextField
                              ...
                              className="formtext"
                              id="cashValueBonus"
                              value={transData.cashValueBonus}
                          ...
                          <Grid item xs={8} md={6} lg={4}>
                            <TextField
                              ...
                              className="formtext"
                              id="gsvPayble"
                              value={transData.gsvPayble}
                              placeholder="GSV Payble"
                              name="gsvPayble"
                              inputProps={{ readOnly: true }}
                              fullWidth
                              variant="outlined"
                      ...
                      {UinData?.productType?.includes("L") ? (
                        <>
                          <Grid item xs={8} md={6} lg={4}>
                            <TextField
                              type="number"
                              label="Ulip Surrender Charge"
                              className="formtext"
                              id="surrenderCharge"
                              value={transData.surrenderCharge}
                              placeholder="Ulip Surrender Charge"
                              name="surrenderCharge"
                              inputProps={{ readOnly: true }}
                              fullWidth
                              variant="outlined"
                              margin="dense"
                        ...
                        >
                          <LocalizationProvider dateAdapter={AdapterDateFns}>
                            <DatePicker
                              ...
                              label="Approval Date"
                              id="approvDate"
                              value={moment(transData.approvDate).format(
                                "YYYY-MM-DD"
                              )}
                      ...
                      >
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <DatePicker
                            ...
                            label="SV Req Date:"
                            id="reqDate"
                            value={moment(purpleData.reqDate).format(
                              "YYYY-MM-DD"
                            )}
                            placeholder="SV Req Date:"
                            name="reqDate"
                      ...
                      >
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <DatePicker
                            ...
                            label="Log Date:"
                            id="logDate"
                            value={moment(purpleData.logDate).format(
                              "YYYY-MM-DD"
                            )}
                            placeholder="Log Date:"
                            name="logDate"
                      ...
                      <>
                        ...
                        <Grid item xs={8} md={6} lg={4}>
                          <TextField
                            ...
                            className="formtext"
                            id="cashValueBonus"
                            value={purpleData.cashValueBonus}
                            placeholder="Cash Value Bonus"
                            name="cashValueBonus"
                            inputProps={{ readOnly: true }}
                            fullWidth
                      ...
                      <>
                        <Grid item xs={8} md={6} lg={4}>
                          <TextField
                            label="Ulip Surrender Charge"
                            className="formtext"
                            id="ulipSurrenderCharges"
                            value={purpleData.ulipSurrenderCharges}
                            placeholder="Ulip Surrender Charge"
                            name="ulipSurrenderCharges"
                            inputProps={{ readOnly: true }}
                            fullWidth
                            variant="outlined"
                            margin="dense"
                          ...
                          >
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                              <DatePicker
                                ...
                                label="Effective Date:"
                                id="effDate"
                                value={moment(purpleData.effDate).format(
                                  "YYYY-MM-DD"
                                )}
                                placeholder="Effective Date:"
                                name="effDate"
              ...
              <>
                ...
                <Grid item xs={8} md={6} lg={6}>
                  <TextField
                    ...
                    value={purpleData.purpleApprovalFlag}
                ...
                <Grid item xs={8} md={6} lg={6}>
                  <TextField
                    ...
                    value={purpleData.purpleApprovalRemark}
                ...
                <Button
                  ...
                  disabled={
                    !(
                      purpleData.purpleApprovalFlag &&
                      purpleData.purpleApprovalRemark
                    )
                  }
                >
                  Submit
