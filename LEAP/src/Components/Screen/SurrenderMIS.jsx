...
function SurrenderMIS() {
  ...
  const getProcessedData = () => {
    axios
      .get(`http://localhost:8080/ipcaSurrender/getAllQCPending/${userId}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
  ...
  const getFailedData = () => {
    axios
      .get(`http://localhost:8080/ipcaSurrender/getAllFailed/${userId}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
  ...
  const getPassedData = () => {
    axios
      .get(`http://localhost:8080/ipcaSurrender/getAllPassed/${userId}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
  ...
  const handleDelete = (val) => {
    ...
    axios
      .patch(
        `http://localhost:8080/ipcaSurrender/reinitiateTrans/${val}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
