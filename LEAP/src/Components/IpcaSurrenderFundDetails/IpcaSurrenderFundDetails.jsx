...
import IpcaSurrenderFundDetailsEdit from "./IpcaSurrenderFundDetailsEdit";
import IpcaSurrenderFundDetailsInfo from "./IpcaSurrenderFundDetailsInfo";
...
function IpcaSurrenderFundDetails() {
  ...
  const getData = () => {
    axios
      .get(`http://localhost:8080/ipcafunddetails/getall/${userId}`, {
        headers: {
  ...
  const globalsearch = (val) => {
    val === ""
      ? getData()
      : axios
          .get(`http://localhost:8080/ipcafunddetails/search/${val}`, {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
            },
          })
  ...
  const editFormSubmit = () => {
    axios
      .patch(
        `http://localhost:8080/ipcafunddetails/update/${record.id}/${userId}`,
        {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .patch(
        `http://localhost:8080/ipcafunddetails/softdelete/${id}/${userId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
  ...
  return (
    <div>
      <div className="classTitle">
        <h2>
          {" "}
          <b>LEAP Surrender Fund Details</b>{" "}
        </h2>
      </div>
...
export default IpcaSurrenderFundDetails;
