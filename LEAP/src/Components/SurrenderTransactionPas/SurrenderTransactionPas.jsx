...
function SurrenderTransactionPas() {
  ...
  const onChangeApprovDate = (date) => {
    setsurrenderTransData({ ...surrenderTransData, approvDate: date });
  };
    ...
    axios
      .post(
        `http://localhost:8080/surrenderTransactionPas/add/${userId}`,
        {
          ...
          gsvPayble: surrenderTransData.gsvPayble,
          ...
          surrenderCharge: surrenderTransData.surrenderCharge,
          ...
          approvDate: moment(surrenderTransData.approvDate)
            .format("YYYYMMDD")
            .toString(),
    ...
    axios
      .patch(
        `http://localhost:8080/surrenderTransactionPas/update/${record.id}/${userId}`,
        {
          ...
          surrenderCharge: record.surrenderCharge,
