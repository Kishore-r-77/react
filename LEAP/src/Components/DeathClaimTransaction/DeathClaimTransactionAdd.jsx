...
function DeathClaimTransactionAdd({
  open,
  data,
  handleClose,
  companyData,
    ...
    <div>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Death Claim Transaction PAS Add</Modal.Title>
        </Modal.Header>
        <Modal.Body>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={8} md={6} lg={3}>
                  <TextField
                    ...
                    margin="dense"
                  >
                    {causeOfDeathData?.map((val) => (
                      <MenuItem key={val} value={val.longDescription}>
                        {val.longDescription}
                      </MenuItem>
                    ))}
                  </TextField>
...
export default DeathClaimTransactionAdd;
