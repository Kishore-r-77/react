...
import DeathClaimCoverAdd from "../DeathClaimCover/DeathClaimCoverAdd";
import DeathClaimCoverInfo from "../DeathClaimCover/DeathClaimCoverInfo";
...
function DeathPolicyCoverDetails({
  open,
  close,
  coverDetails,
  setcoverDetails,
...
export default DeathPolicyCoverDetails;
