...
function DeathClaimLeapFundDetailsInfo({ open, handleClose, data }) {
  return (
    <div>
      <Modal
        show={open}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Ipca Surrender Fund Details Info</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default DeathClaimLeapFundDetailsInfo;
